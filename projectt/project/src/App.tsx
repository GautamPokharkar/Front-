...
import DownloadScriptsPage from './components/DownloadScriptsPage'; // Script Download Page
...
function App() {
  ...
  useEffect(() => {
    // Check if user is already logged in by looking for the role in localStorage
      ...
      <Router>
        {isLoggedIn ? (
          <div className="min-h-screen bg-gray-50 dark:bg-cyber-darker transition-colors duration-200">
            <TopNavbar />
            <div className="flex">
              {/* Pass userRole and handleSignOut to Sidebar */}
              <Sidebar
